...
export async function POST() {
  try {
    ...
    console.log('Mesha created:', mesha.id);
    ...
    console.log('Musiche created:', musiche.id);
    ...
    console.log('Mesha profile created:', meshaProfile.id);
    ...
    console.log('Musiche profile created:', musicheProfile.id);
    ...
    console.log('Assigning missions...');
